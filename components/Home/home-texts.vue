<template>
<v-row :justify="$mq=='lg' ? 'center' : 'end'">
    <v-col cols="12" lg="8">
        <h2 class="orange-text">Buscás mejorar tu calidad de vida? Llevar tu plenitud al máximo?</h2>
    </v-col>
    <v-col cols="11" lg="8">
        <p class="pl-lg-16 fs-18">
    ...
    <v-col cols="12" lg="8">
        <h2 class="orange-text">En Re Crearse trabajamos modalidad online</h2>
    </v-col>
    <v-col cols="11" lg="8">
        <p class="pl-lg-16 fs-18">
    ...
    <v-col cols="12" lg="8">
        <h2 class="orange-text">Querés hacernos una pregunta o consulta?</h2>
    </v-col>
    <v-col cols="11" lg="8">
        <p class="pl-lg-16 fs-18">
            Podés contactarnos por WhatsApp al
            <span class="orange-bold">11 2408 5256</span>
            o
            <span class="orange-bold">11 3073 5034</span>, o podes completar el siguiente formulario
        </p>
    </v-col>
</v-row>
</template>
