...
<v-row :justify="$mq=='lg' ? 'center' : 'end'">
    <v-col cols="12" lg="8">
        <h2 class="first-text">Buscás mejorar tu calidad de vida? Llevar tu plenitud al máximo?</h2>
    </v-col>
    <v-col cols="11" lg="8">
    ...
    <v-col cols="12" lg="8">
        <h2 class="first-text">En Re Crearse trabajamos modalidad online</h2>
    </v-col>
    <v-col cols="11" lg="8">
        <p class="pl-lg-16 fs-lg-20 fs-sm-18">
    ...
    <v-col cols="12" lg="8">
        <h2 class="first-text">Querés hacernos una pregunta o consulta?</h2>
    </v-col>
    <v-col cols="11" lg="8">
        <p class="pl-lg-16 fs-lg-20 fs-sm-18">
